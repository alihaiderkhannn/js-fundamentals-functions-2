...
function calculatePreparationTime(numberoflayer) {

  const minutesperlayer = 3;

  return minutesperlayer * numberoflayer


}

// console.log(calculatePreparationTime(5))
...
function totalTimeSpent(numberoflayer, minutes) {

  const totaltime = calculatePreparationTime(numberoflayer) + minutes

  return totaltime
}

console.log(totalTimeSpent(3,15))
